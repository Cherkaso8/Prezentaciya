    ...
    <NoirFrame>
      <div style={{
        ...
        <div style={{
          ...
          Криминальная курьерша, мечтающая уйти из дела, переживает покушение —
          и не может отделаться от восьмилетней беспризорницы, единственной свидетельницы нападения.
          Пока они ищут заказчика, их случайная связь становится опаснее любой погони:
          впервые обе получают шанс вырваться из жизни, которую за них выбрали.
        </div>
      </div>
    </NoirFrame>
  );
