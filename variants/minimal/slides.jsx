    ...
    <MinFrame>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', maxWidth: 1400 }}>
        ...
        <div style={{
          ...
          Криминальная курьерша, мечтающая уйти из дела, переживает покушение — и не может отделаться от восьмилетней беспризорницы, единственной свидетельницы нападения.
          <span style={{ color: MIN.inkDim }}> Пока они ищут заказчика, их случайная связь становится опаснее любой погони: впервые обе получают шанс вырваться из жизни, которую за них выбрали.</span>
        </div>
      </div>
    </MinFrame>
  );
