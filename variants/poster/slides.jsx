    ...
    <PosFrame bg={POS.accent} ink={POS.cream}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', maxWidth: 1500, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <span style={{ color: POS.ink }}>Криминальная курьерша</span>, мечтающая уйти из дела, переживает покушение — и не может отделаться от <span style={{ color: POS.ink }}>восьмилетней беспризорницы</span>, единственной свидетельницы нападения.
        </div>
        <div style={{
          ...
          Пока они ищут заказчика, их случайная связь становится опаснее любой погони: впервые обе получают шанс вырваться из жизни, которую за них выбрали.
        </div>
      </div>
    </PosFrame>
  );
...
function P15_Tone() {
  const rows = [
    ...
    ['Цвет',   'три цвета в конфликте: жёлтый (мир доставки, деньги, ловушка), красный (насилие, акцент), холодный синий (ночь, одиночество, финал). Палитра не создаёт уют — она создаёт давление.'],
...
function P_WhyNow() {
  const blocks = [
    ...
    {
      label: 'Ставка.',
      text: 'Олег убьёт Оливию, если она не исчезнет. Оливия исчезнет, если бросит Машу. Маша умрёт, если Оливия исчезнет. Три человека тянут друг друга вниз — и вверх одновременно.',
    },
  ];
  return (
    <PosFrame bg={POS.ink} ink={POS.cream}>
