      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontSize: 44, lineHeight: 1.25, color: POS.cream, opacity: 0.88,
            maxWidth: 900, textAlign: 'right'
          }}>
        ...
        <div>
          <div style={{
            ...
            <div style={{
              ...
              Человек, которого Оливия считала семьёй, хочет её убить.
              Девочка, от которой она пыталась избавиться, становится единственной причиной не сдаться.
            </div>
          </div>
          <div style={{ height: 340, marginTop: 20, border: `4px solid ${POS.ink}` }}>
            <PosImage src="../../assets/refs/sketchbook-01.png" filter="warm" />
          </div>
        </div>
      </div>
    </PosFrame>);
    ...
    <div style={{
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
        <div style={{ position: 'relative' }}>
          <PosImage src="../../assets/chars-hero.jpg" filter="red" />
        </div>
        <div style={{
...
function P09_Oleg() {return <PCharFull idx={10} name="Олег" age="60 лет" role="Глава организации · работодатель Оливии"
  ...
  body={<>Заурядный внешний вид скрывает жестокого, расчётливого главу организации по отмыву, обналичиванию и транспортировке нелегальных денег.<br /><br />Не принимает сына — что на самом деле есть попытка защитить, вытеснив из своего мира. <b>В финале собственноручно расстреливает Тимура</b>, не узнав его под маской — своими руками, отстраняя сына, толкал его к гибели.</>}
  wants="Нормального наследника. Работодатель Оливии." />;}

// ── 10. Дуэт Сухой + Гуддини ─────────────────────────────────
function P10_Trio() {
  const duo = [
  { name: 'Сухой', role: 'Уборщик · мечтатель', img: null, color: POS.ink,
  ...
  { name: 'Гуддини', role: 'Уборщик · напарник', img: null, color: POS.ink,
...
function P14_Arc() {
  ...
  { n: 'I', t: 'Экспозиция', eps: '1–2', dark: false,
    text: 'Оля — профессионал. Маша — обуза. Мир опасен. Последний заказ оборачивается засадой: Маша становится свидетельницей.' },
  { n: 'II', t: 'Усложнение', eps: '3–4', dark: true,
    text: 'Маша начинает приносить пользу. Угроза множится. Артём — активная сила. Связь Оли и Маши крепнет.' },
  { n: 'III', t: 'Перелом', eps: '5–6', dark: false,
    text: 'Смена тональности. Ночная одиссея Маши. Пистолет применён. Ложный покой: один вечер как награда. Таран в финале — всё рушится.' },
  { n: 'IV', t: 'Обрушение и финал', eps: '7–8', dark: true,
    text: 'Квартира взорвана. Олег знает всё. Тимур погибает от руки отца. Оля — от случайной пули. Маша уезжает в Крым.' }];

  const eps = [
  ['01', 'Экспозиция', 'Оля — профессионал. Маша — обуза.'],
  ['02', 'Засада', 'Последний заказ. Маша — свидетель.'],
  ['03', 'Связь', 'Маша приносит пользу. Угроза множится.'],
  ['04', 'Артём', 'Активная сила. Поиски предателя.'],
  ['05', 'Ночь', 'Одиссея Маши. Пистолет применён.'],
  ['06', 'Ложный покой', 'Стрельбище, гончарка, кино. Таран.'],
  ['07', 'Обрушение', 'Квартира взорвана. Олег знает.'],
  ['08', 'Финал', 'Тимур и Оля — убиты. Маша уезжает.']];
    ...
    <PosFrame>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'start', marginTop: 40 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          {[
          ['../../assets/ref-peaky-thomas.png', 'hot'],
          ['../../assets/ref-scene-solitude.png', 'crush'],
          ['../../assets/ref-oleg-face.png', 'mono'],
          ['../../assets/ref-olivia-art.png', 'red']].
          map(([src, f], i) =>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            «Джон Уик в мире доставки. Только доставляют не смерть — доставляют <b style={{ color: POS.yellow, fontStyle: 'normal' }}>всё</b>.»
          </div>
        </div>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 80, alignItems: 'start', marginTop: 30 }}>
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            {[
            ['Острые козырьки', 'атмосфера, типаж', POS.ink, POS.cream],
            ['Леон', '«взрослый + ребёнок»', POS.cream, POS.ink],
            ['Карты, деньги, два ствола', 'стиль рассказа, юмор', POS.cream, POS.ink],
            ['Фарго', 'смешение жанров', POS.ink, POS.cream]].
            map(([t, d, bg, fg]) =>
            <div key={t} style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          textTransform: 'uppercase', whiteSpace: 'nowrap',
          color: POS.cream, margin: 0,
          textShadow: '0 6px 0 rgba(199, 54, 31, 0.35)'
        }}>Интерференция</h1>
        <div style={{
          marginTop: 36, display: 'grid', gridTemplateColumns: 'auto 1fr auto auto auto',
          gap: 40, alignItems: 'baseline',
          borderTop: `3px solid ${POS.cream}`, paddingTop: 24
        }}>
          <div style={{
            fontFamily: POS_FONTS.slab, fontWeight: 500,
            fontSize: 22, letterSpacing: '0.4em', textTransform: 'uppercase',
          ...
          <div />
          {[['Контакт', '[Имя]'], ['Email', '[email@example.com]'], ['Телефон', '[+7 ___ ___ __ __]']].map(([k, v]) =>
          <div key={k}>
              <div style={{
              fontFamily: POS_FONTS.slab, fontWeight: 600, fontSize: 11,
              letterSpacing: '0.45em', textTransform: 'uppercase',
              ...
              color: POS.cream, letterSpacing: '0.02em'
            }}>{v}</div>
            </div>
          )}
        </div>
...
Object.assign(window, {
  ...
  P12_SynopsisSection, P13_Synopsis, P14_Arc, P15_Tone, P16_CourierWorld,
